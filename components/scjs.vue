            ...
            <div class="cell">
                <div class="modal_cont">
                    ...
                    <div class="mod_scjs">
                        ...
                        <div class="mod_btn">
                            <a ondragstart="return false" class="a1" href="javascript:void(0)" @click="funDelTeacher">确定</a><a ondragstart="return false" href="javascript:void(0)" @click="close()">取消</a>
                        </div>
                    </div>
                </div>
            </div>
