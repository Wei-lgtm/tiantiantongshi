            ...
            <div class="cell">
                <div class="modal_cont">
                    ...
                    <div class="mod_tjjs">
                        ...
                        <div class="mod_btn">
                            <a class="a1" href="javascript:void(0)" @click="funAddTeacher">确定</a><a href="javascript:void(0)" @click="close()">取消</a>
                        </div>
                    </div>
                </div>
            </div>
...
export default {
  ...
  methods: {
    ...
    funAddTeacher(){
      const that = this
      if(!that.teacherName && !that.mobile && !that.jobNum && !that.password){
